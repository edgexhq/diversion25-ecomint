        ...
        <div className="space-y-6 col-span-2">
          <div>
            ...
            <p className="text-gray-400">
              ...
              <span className="text-blue-500">
                {type === "nft"
                  ? nft!.owner?.slice(0, 10)
                  : listing!.creatorAddress.slice(0, 10)}
                ...
              </span>
            </p>
          ...
          <div className="space-y-2">
            <Collapsible open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
              <CollapsibleTrigger className="flex items-center justify-between w-full p-4 rounded-lg">
                <span className="font-semibold">Details</span>
                {isDetailsOpen ? <ChevronUp /> : <ChevronDown />}
              </CollapsibleTrigger>
              <CollapsibleContent className="p-4 mt-1 rounded-lg">
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Contract Address</span>
                    <div className="flex items-center gap-2">
                      <span className="text-primary">
                        {collectionAddress.slice(0, 10)}...
                      </span>
                      <Button
                        variant="outline"
                        size="icon"
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {type === "listed" ? listing!.asset.id : nft?.id}{" "}
                    </span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {type === "nft" && nft && (
                    <div className="flex justify-between">
                      <span className="text-gray-400 w-full">Token URI</span>
                  ...
                  {type === "listed" && listing && (
                    <div className="flex justify-between">
                      ...
                      <Badge className="rounded-full bg-blue-500 hover:bg-blue-600 text-white">
                        {listing.status}
                      </Badge>
                    </div>
                  )}
