  ...
  return (
    <>
      ...
      <div className="min-h-screen py-16 px-10 md:px-48 grid grid-cols-1 md:grid-cols-2 gap-5 overflow-x-hidden">
        ...
        {/* Details Section */}
        <Card className="group bg-secondary/20 shadow-[inset_0_3px_8px_rgba(0,255,128,0.2),inset_0_-3px_8px_rgba(0,255,128,0.15)] hover:shadow-[inset_0_4px_12px_rgba(0,255,128,0.25),inset_0_-4px_12px_rgba(0,255,128,0.2)] relative h-96">
